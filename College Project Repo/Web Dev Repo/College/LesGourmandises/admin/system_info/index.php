		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					<label for="dollar-rate" class="control-label">Dolar-rate</label>
					<input type="text" class="form-control form-control-sm" name="dollar-rate" id="dollar-rate" value="<?php echo $_settings->info('dollar-rate') ?>">
				</div>
				<div class="form-group">
					<label for="pass" class="control-label">Staff-Pasword</label>
					<input type="password" class="form-control form-control-sm" name="pass" id="pass" value="<?php echo $_settings->info('pass') ?>">
				</div>
				<div class="form-group">
