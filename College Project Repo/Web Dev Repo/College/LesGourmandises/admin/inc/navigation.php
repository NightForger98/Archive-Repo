...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar-no-expand">
        ...
        <span style="font-size: 25px !important;font-weight: bold;" class="brand-text font-weight-light"><?php echo $_settings->info('short_name') ?></span>
        </a>
        <!-- Sidebar -->
          ...
          <div class="os-padding">
            <div class="os-viewport os-viewport-native-scrollbars-invisible" style="overflow-y: scroll;">
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <!-- Sidebar Menu -->
                <nav class="mt-4">
                   <ul style="font-size: 30px !important;font-weight: bold;" class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <?php endif; ?>
                      ...
                      <li class="nav-item dropdown">
                        <a href="<?php echo base_url ?>admin/?page=expenses" class="nav-link nav-sales_manage_sale">
                          <i class="nav-icon fas fa-plus"></i>
                          <p>
                            Expensens
                          </p>
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=report_expenses" class="nav-link nav-report_expenses">
                        <i class="nav-icon fas fa-calendar-day"></i>
                        <p>
                          Report EX
                        </p>
