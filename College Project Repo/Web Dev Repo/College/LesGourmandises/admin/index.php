...
<body class="sidebar-mini layout-fixed control-sidebar-slide-open layout-navbar-fixed sidebar-mini-md sidebar-mini-xs text-sm" data-new-gr-c-s-check-loaded="14.991.0" data-gr-ext-installed="" style="height: auto;">
  <div class="wrapper">
    ...
    <?php 
    if ($page == "sales/manage_sale") {
      echo "content-wrapper p-0 m-0";
    }else{
      echo "content-wrapper  pt-3 pb-4";
    }
    
    ?>
    
    " style="min-height: 567.854px;">

      <!-- Main content -->
      <section class="
        <?php 
        if ($page == "sales/manage_sale") {
          echo "content  text-dark p-0 m-0";
        }else{
          echo "content  text-dark";
        }
