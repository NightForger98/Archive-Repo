...
<div class="container-fluid">
	<form action="" id="category-form">
		...
		<div class="form-group">
			...
			<textarea type="text" name="description" id="description" class="fdx form-control form-control-sm rounded-0" required><?php echo isset($description) ? $description : ''; ?></textarea>
		</div>
		<div class="form-group">
