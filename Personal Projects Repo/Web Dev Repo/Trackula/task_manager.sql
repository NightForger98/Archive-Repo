...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 07, 2025 at 06:03 PM
...
(1, 'finish project part 2', '                                        \r\n                \r\n                ', 11, 'Medium', '2025-10-07'),
(6, 'web page design', '                                        do da work\r\n                \r\n                ', 9, 'High', '2025-01-11'),
(12, 'video make', 'part2 video', 9, 'Low', '2025-01-10'),
(13, 'proj part 1 & done', '                                                            done\r\n                \r\n                \r\n                ', 14, 'Medium', '2025-01-09'),
(14, 'finish video', 'urgent', 11, 'High', '2025-01-15'),
(15, 'buy cd', '', 18, 'Low', '2025-01-16'),
(16, 'print to cd', '                                                                                \r\n          test      \r\n                \r\n                \r\n                ', 9, 'Low', '2025-01-16');
...
--
ALTER TABLE `tbl_lists`
  MODIFY `list_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
